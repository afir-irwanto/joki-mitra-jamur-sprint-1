...
<head>
    ...
    <!-- site metas -->
    <title>MitraJamur - Workshop</title>
...
<body class="main-layout">
    ...
    <div class="collection_text">Workshop Details</div>
   <div class="about_main layout_padding">
    <div class="collection_section">
    	<div class="container">
    		<h1 class="new_text"><strong>{{$data->namaWorkshop}}</strong></h1>
    	    <p class="consectetur_text">{{$data->deskripsiWorkshop}}</p>
    	</div>
    </div>
    <div class="collectipn_section_3 layout_padding">
    	<div class="container">
    		<div class="racing_shoes">
    			<div class="row">
    				<div class="col-md-6">
    					<div class="shoes-img3"><img src="{{ asset('foto-workshop/'.$data->gambarWorkshop) }}" style="width: 50%;" alt=""></div>
    				</div>
    				<div class="col-md-6">
    					<div class="sale_text"><strong>Waktu <br><span style="color: #0a0506;">Pelaksanaan :</span> <br>{{$data->waktuWorkshop}}</strong></div>
    					<div class="number_text"><strong>Rp <span style="color: #0a0506">{{number_format($data->hargaWorkshop)}}</span></strong></div>
                        <form action="/user/workshop/daftar/{{$data->id}}" method="post">
                            ...
                            <button class="seemore">Join Workshop</button>
                        </form>
    				</div>
    			</div>
    		</div>
