...
<body class="main-layout">
    ...
    <div class="collection_text">List of Products</div>
    <div class="layout_padding gallery_section">
        <div class="container">
                    ...
                    <div class="best_shoes">
                        ...
                        <div class="star_text">
                            ...
                            <div class="text-right">
                                <a href="#" class="btn btn-warning btn-sm"><i class="fa fa-shopping-cart"></i></a>
                                <a href="/user/produk/detail/{{$dt->id}}" class="btn btn-primary btn-sm">See Details</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="buy_now_bt">
                <button class="buy_text" onclick="location.href='/user/dashboard'">Back to Home</button>
            </div>
        </div>
    </div>
